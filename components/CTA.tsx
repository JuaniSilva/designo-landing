...
export default function CTA() {
  return (
    <Container className='-mt-20 translate-y-1/2 px-mobile-horizontal-spacing md:translate-y-1/4 md:px-tablet-horizontal-spacing lg:px-0'>
      <section className='flex flex-col items-center rounded-2xl bg-primary-peach bg-cta-pattern bg-cta-position bg-no-repeat px-5 py-16 md:bg-cta-position-tablet lg:flex-row lg:px-24'>
